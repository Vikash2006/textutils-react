...
export default function Navbar(props) {
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <button type="button" onClick={props.defaulter} className="btn btn-light mx-2">default</button>
      <button type="button" onClick={props.bluemode} className="btn btn-primary mx-2">blue</button>
